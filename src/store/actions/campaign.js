...
export const unlockpremiumcateApi = ({ cat_id = '', onSuccess = () => {}, onError = () => {}, onStart = () => {} }) => {
  store.dispatch(
    apiCallBegan({
...
// get system language list
export const getsystemLanguageListApi = ({ onStart = () => {}, onSuccess = () => {}, onError = () => {} }) => {
  store.dispatch(
    apiCallBegan({
      ...getSystemLanguageListApi(),
      displayToast: false,
...
// get system language json

export const getsystemLanguageJson = ({
  language = '',
  onStart = () => {},
  onSuccess = () => {},
  onError = () => {}
  ...
  store.dispatch(
    apiCallBegan({
      ...getSystemLanguageJson(language),
      displayToast: false,
      onStart,
      onSuccess,
      onError
