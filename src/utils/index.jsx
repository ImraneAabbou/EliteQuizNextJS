...
import { getbookmarkApi, ReportQuestionApi, setbookmarkApi } from "../store/actions/campaign";
...
export const handleBookmarkClick = (question_id, isBookmarked, type) => {
...
export const t = (label) => {
    const langData = store.getState().Languages?.languageJsonData && store.getState().Languages?.languageJsonData[label];
    if (langData) {
        return langData;
