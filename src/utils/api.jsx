...
// Language data
export const GET_SYSTEM_LANGUAGE_LIST = "get_system_language_list"
export const GET_SYSTEM_LANGUAGE_JSON = "get_system_language_json"
...
//57. get system lenguage list 
export const getSystemLanguageListApi = () => {
    return {
        url: `${GET_SYSTEM_LANGUAGE_LIST}`,
        method: 'POST',
        data: {
            from: 2
        },
...
//58. get system lenguage json file 
export const getSystemLanguageJson = (language) => {
    return {
        url: `${GET_SYSTEM_LANGUAGE_JSON}`,
        method: "POST",
        data: {
            from: 2,
            language: language
