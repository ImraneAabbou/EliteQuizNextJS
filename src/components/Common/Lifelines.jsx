...
const Lifelines = ({
  ...
  return (
    <div className='dashoptions row'>
      {showFiftyFifty ? (
        <div
          className='fifty__fifty col-12 col-sm-12 col-md-3 custom-life-btn'
        >
          <button
            className={`btn btn-primary fiftybtn py-2 costMarginLeft ${status.fifty_fifty && 'bg-secondary'}`}
      ...
      {audiencepoll ? (
        <div
          className='audience__poll col-12 col-sm-12 col-md-3 custom-life-btn'
        >
          <button
      ...
      <div
        className='resettimer col-12 col-sm-12 col-md-3 custom-life-btn'>
        <button
      ...
      {totalQuestions > 1 && (
        <div className='skip__questions col-12 col-sm-12 col-md-3 custom-life-btn'>
          <button
            className={`btn btn-primary p-2 costMarginRight ${status.skip_question && 'bg-secondary'}`}
