...
const dispatch = useDispatch()
  ...
  const emojis = emoji.map(data => <button className='emoji' onClick={() => handleClick(data.src)} key={data.id}><Image src={`/images/emojis/${data.src}`} height="50px" width='50px' /></button>);
