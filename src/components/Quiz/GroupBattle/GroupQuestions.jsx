...
import { getFirestore, collection, doc, onSnapshot, query, updateDoc, deleteDoc, where, runTransaction, getDoc } from 'firebase/firestore';
...
const GroupQuestions = ({ questions: data, timerSeconds, onOptionClick, onQuestionEnd }) => {
    ...
    <div>
      {msgData ? (
        ...
        msgData.isTextMessage ? (
          ...
          msgData.message && (
            <div>
              <Image src={`/images/emojis/${msgData.message}`} height={50} width={50} alt="Message Image" />
            </div>
          )
        )
      ) : (
  ...
  return (
    <React.Fragment>
      ...
      <div className="questions battlequestion groupbattle" ref={scroll}>
        <div className="inner__headerdash groupPlay_header topLowerSection m-0">
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }} className='topUpperSection pt-4'>
          <ShowMessagePopUp />
        </div>
<div className='topLowerSection pt-1'>
