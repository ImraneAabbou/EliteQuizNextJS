...
import { getFirestore, doc, onSnapshot,updateDoc, deleteDoc, getDoc } from 'firebase/firestore';

const MySwal = withReactContent(Swal)

const RandomQuestions = ({ questions: data, timerSeconds, onOptionClick, onQuestionEnd }) => {
