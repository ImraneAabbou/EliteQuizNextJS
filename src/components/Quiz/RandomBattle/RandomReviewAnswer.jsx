    ...
    return (
        <React.Fragment>
            ...
            <div className="text-center review-answer-data">
                <small className="review-latext-note">{questions[currentQuestion].note ? <><span class="text-nowrap">{t("note")} :- &nbsp; </span> <p dangerouslySetInnerHTML={{ __html: purify.sanitize(questions[currentQuestion].note) }}></p></> : ""}</small>
            </div>
        </React.Fragment>
    );
}
