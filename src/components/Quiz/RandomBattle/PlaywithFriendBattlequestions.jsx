...
import RoundTimer from 'src/components/Common/RoundTimer';
    ...
    onSnapshot(documentRef,
      doc => {
        ...
        if (doc.exists && doc.data()) {
          ...
          setUserProfile({ user1: battleroom.user1.profileUrl, user2: battleroom.user2.profileUrl })
    ...
    <div>
      {msgData ? (
        msgData.isTextMessage ? (
          ...
          msgData.message && (
            <div>
              <Image src={`/images/emojis/${msgData.message}`} height="50px" width="50px" />
            </div>
          )
        )
      ) : (
        ...
        <div className='user_data onevsone below_1400'>
          <div className='user_one mb-4'>
            ...
            <div className='inner__headerdash'>
              ...
              {questions && questions[0]['id'] !== '' ? (
                <RoundTimer ref={user1timer} timerSeconds={timerSeconds} onTimerExpire={onTimerExpire} userProfile={userProfile.user1}/>
              ) : (
                ''
              )}
            </div>
          ...
          <div className='user_two mb-4'>
            ...
            <div className='inner__headerdash'>
              ...
              {questions && questions[0]['id'] !== '' ? (
                <RoundTimer ref={user2timer} timerSeconds={timerSeconds} onTimerExpire={() => { }} userProfile={userProfile.user2} />
              ) : (
                ''
              )}
            </div>
