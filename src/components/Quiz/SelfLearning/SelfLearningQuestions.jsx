...
function SelfLearningQuestions({ questions: data, timerSeconds, onOptionClick }) {
    ...
    return (
        <React.Fragment>
            <div className='dashboardPlayUppDiv funLearnQuestionsUpperDiv selfLearnQuestionsUpperDiv text-end p-4 pb-0 topUpperSection'>
            ...
            <div className="questions selflearnigque" ref={scroll}>
                <div className="timerWrapper">
                    <div className="inner__headerdash topLowerSection">
                ...
                <div className="dashoptions selfLearnLifelines">
                    <div className="fifty__fifty pb-2 ">
                        <button className="btn btn-primary mx-2" onClick={previousQuestion} disabled={disablePrev}>
                    ...
                    <div className="notification self-learning-pagination pb-2">
                        <Button className="notify_btn btn-primary mx-2" onClick={() => setNotificationModal(true)}>
                    ...
                    <div className="skip__questions pb-2 ">
                        <button className="btn btn-primary mx-2" onClick={nextQuestion} disabled={disableNext}>
                    ...
                    <div className="resettimer pb-2">
                        <button className="btn btn-primary mx-2" onClick={onSubmit}>
                            {t("submit")}
                        </button>
                    </div>
