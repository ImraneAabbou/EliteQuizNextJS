...
import { decryptAnswer, handleBookmarkClick, imgError } from "src/utils";
...
<div className="guessTheWord_review_top_sec">
      <div className="inner__headerdash" style={{width:'220px'}}>
        <div className="total__out__leveldata coinsdata">
          <h5 className="inner__total-leveldata">
            {currentQuestion + 1} - {questions?.length}
          </h5>
        </div>
        <div className="total__out__leveldata coinsdata guessTheWord_right_sec py-2 mt-0">
          <Bookmark
      ...
      <div className="content__text bg_background">
