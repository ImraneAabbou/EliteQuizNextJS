...
import { setQuizCategoriesApi, UserCoinScoreApi, UserStatisticsApi } from 'src/store/actions/campaign'
...
const AudioQuestionsDashboard = ({
  ...
  return (
    <React.Fragment>
      <div className='dashboardPlayUppDiv funLearnQuestionsUpperDiv text-end p-4 pb-0 audio_questions_top_margin topUpperSection'>
{!isBookmarkPlay &&
...
<div className='row morphisam'> 
        <div className='content__text col-12 col-lg-8 '>
          <p className='question-text pt-4'>{questions[currentQuestion].question}</p>
          {/* Audio Questions Player */}
        <div className='audio_player text-center p-2 pt-4'>
          <audio
